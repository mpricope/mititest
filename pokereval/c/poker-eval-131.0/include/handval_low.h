...
DllExport extern POKEREVAL_EXPORT int LowHandVal_toString(LowHandVal hv, char *outString);
DllExport extern POKEREVAL_EXPORT int LowHandVal_print(LowHandVal handval);

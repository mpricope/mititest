...
DllExport extern POKEREVAL_EXPORT int StdRules_HandVal_toString(HandVal handval, char *outString); 
DllExport extern POKEREVAL_EXPORT int StdRules_HandVal_print(HandVal handval);
